        ...
        <div className="section">
          <Container>
            ...
            <h5 className="description">
              ...
              ensure your appliances are always in top working condition.
            </h5>
            <Row>
              <Col className="ml-auto mr-auto" md="6">
                <h4 className="title text-center">Our services</h4>
                    ...
                    <Row className="collections">
                      <Col md="6">
                        <img
                          ...
                          src={require("assets/img/acrepair.png")}
                        ></img>
                        <img
                          alt="..."
                          className="img-raised"
                          src={require("assets/img/mechanic.png")}
                        ></img>
                      </Col>
                      <Col md="6">
                        <img
                    ...
                    <Row className="collections">
                      <Col md="6">
                        <img
                          alt="..."
                          className="img-raised"
                          src={require("assets/img/bgac11.jpg")}
                        ></img>
                        <img
                          alt="..."
                          className="img-raised"
                      ...
                      <Col md="6">
                        <img
                          alt="..."
                          className="img-raised"
                          src={require("assets/img/bglac.jpg")}
                        ></img>
                        <img
                          alt="..."
                          className="img-raised"
                          src={require("assets/img/bgmac.jpg")}
                        ></img>
                      </Col>
                    </Row>
                  </Col>
